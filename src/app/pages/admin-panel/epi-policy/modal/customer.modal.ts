...
@Component({
    ...
    providers: [CustomerService, EPIPolicyService]
})
// tslint:disable-next-line:component-class-suffix
export class CustomerEPIModalContent implements OnInit {
    @Input() id;
    @Input() flagBundle;
    ...
    constructor(public activeModal: NgbActiveModal,
        ...
        public epiPolicyService: EPIPolicyService,
    ...
    getList() {
        ...
        this.epiPolicyService.getListCustomer(params).subscribe(res => {
            try {
