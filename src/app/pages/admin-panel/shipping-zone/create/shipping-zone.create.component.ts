...
export class ShippingZoneCreateComponent implements OnInit {
    ...
    // getListRefundMethod() {
    //     this.shippingZoneService.getRefundMethod().subscribe(res => {
    //         this.listMaster['refund_method'] = res.data;
    //     });
    // }

    // getListPaymentTerm() {
    //     this.shippingZoneService.getPaymentTerm().subscribe(res => {
    //         this.listMaster['payment_term'] = res.data;
    //     });
    // }

    // getListApprover() {
    //     this.shippingZoneService.getApprover().subscribe(res => {
    ...
    getOrderReference(id) {
        ...
        // this.shippingZoneService.getOrderReferenve(params).subscribe(res => {
        //     const data = res.data;
        ...
        //     this.updateTotal();
        // });
        this.shippingZoneService.getOrderInfo(id).subscribe(res => {
            const data = res.data;
    ...
    // getListReturnReason() {
    //     this.shippingZoneService.getReturnReason().subscribe(res => {
    ...
    createRMA() {
        ...
        this.shippingZoneService.createRMA(this.generalForm.value).subscribe(res => {
