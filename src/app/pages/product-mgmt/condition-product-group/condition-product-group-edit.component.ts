...
@Component({
  selector: 'app-condition-group-edit',
  templateUrl: './condition-product-group-edit.component.html'
  
})
export class ConditionProductGroupEditComponent implements OnInit { 
   /**
