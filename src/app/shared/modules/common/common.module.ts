...
import { cdArrowTable, SortColumnDirective, UppercaseDirective, TrueFalseValueDirective, NgStickyDirective } from '../../directives/index';
...
@NgModule({
    ...
    declarations: [cdArrowTable, SortColumnDirective, UppercaseDirective, TrueFalseValueDirective,
        DateObjectPipe, Select2Pipe, ShortcutComponent, NgStickyDirective],
    exports: [cdArrowTable, SortColumnDirective, UppercaseDirective, DateObjectPipe, TrueFalseValueDirective,
        FormsModule, ReactiveFormsModule, NgbModule, TextMaskModule, NgSelectModule, ShortcutComponent, NgStickyDirective],
